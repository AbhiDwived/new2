...
export default function Photobooth() {
  ...
  // console.log("photobooth", photobooth);

  const photobooth = useMemo(() => {
    return data?.vendors?.filter(v => v.vendorType === "Photobooth") || [];
  }, [data]);
  ...
  useEffect(() => {
    if (!photobooth) return;

    let sorted = [...photobooth];
