...
export default function Videography() {
    ...
    // const videography = data?.vendors?.filter(v => v.vendorType === "Videography");
    // console.log("vendorPromotion", vendorPromotion);

    const videography = useMemo(() => {
        return data?.vendors?.filter(v => v.vendorType === "Videography") || [];
    }, [data]);
    ...
    useEffect(() => {
        if (!videography) return;

        let sorted = [...videography];
