...
const UserSidebar = () => {
    ...
    const menuItems = [
        ...
        { to: '/inquiry', label: 'Inquiry', icon: <TbDeviceImacSearch /> },
        { to: '/check-list', label: 'Checklist', icon: <VscChecklist /> },
        { to: '/budget', label: 'Budget', icon: <VscChecklist /> },
        { to: '/saved-vendor', label: 'SavedVendor' },
        { to: '/guest-list', label: 'Guest List', icon: <FaPeopleGroup /> },
    ...
    return (
        <aside
            className={`top-0 left-0  bg-[#0f304d] shadow-md transition-all duration-300 z-50 ${isSidebarOpen ? 'w-64' : 'w-20'}`}
        >
            {/* Toggle Button */}
